...
MONITOR_FAILURE_REWARD = 0
RETRIEVAL_FAILURE_REWARD = 0
...
DIAMOND_TIER_REWARD_FACTOR = 0.999
GOLD_TIER_REWARD_FACTOR = 0.888
SILVER_TIER_REWARD_FACTOR = 0.777
...
SILVER_TIER_TOTAL_SUCCESSES = 10**1  # 1,000
