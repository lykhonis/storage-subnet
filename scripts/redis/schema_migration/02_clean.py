...
from storage.miner.database import safe_remove_all_old_keys
...
async def main(args):
    ...
    try:
        ...
        bt.logging.info("Cleaning up old schema...")
        await safe_remove_all_old_keys(database)
        bt.logging.info("Cleanup of old schema complete.")

    except Exception as e:
        bt.logging.error(f"Error cleaning old schema: {e}")
